...
export default function NewSeries() {
  ...
  return (
    <div className="px-[24px] max-sm:px-[8px] mb-[104px]">
      ...
      max-md:flex-col max-md:pt-[257px]"
      >
        {/* 1번 */}
        <div
          className="[width:calc(50%-12px)] pl-[16px] absolute top-[130px] right-0 
          max-md:top-[40px] max-md:rigth-[50%] max-md:transform max-md:-translate-x-[50%]"
        >
        ...
        >
          ...
          >
            ...
            <div
              className="bg-[#fff] rounded-[6px] p-[10px] -mt-[16px] ml-[16px]
              "
            >
              <div className="flex gap-[2.5px] items-center h-[32px]">
                ...
                <div
                  className="border text-[12px] py-[6px] px-[8px] rounded-[6px]"
        ...
        {/* 테블릿분기점요소 */}
        <div
          className="[width:calc(50%-12px)] mx-auto hover:-translate-y-5 transition-transform
        ...
        >
          {latestItems?.map((item) => (
            <Link
              key={item.id}
              to={`/article/${item.id}`}
              className="mx-auto text-[18px] relative flex text-[#111] font-semibold mb-[20px] max-sm:mb-[40px]"
            >
              <div className="max-md:w-[143px] ">
                ...
                pr-[16px] max-md:pr-0 max-md:h-[143px]"
                />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-[51px] h-[32px]  absolute left-[10px] top-[10px] border border-[#00d48d] 
              ...
              <div className="bg-[#fff] rounded-[6px] p-[10px] absolute -bottom-[16px] right-[16px]">
                <div className="flex gap-[2.5px] items-center h-[32px]">
                  <div
